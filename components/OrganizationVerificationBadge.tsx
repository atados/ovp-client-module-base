...
const m = defineMessages({
  verified: {
    id: 'organizationVerificationBadge.verified',
    defaultMessage: 'ONG Verificada',
  },
})
...
OrganizationVerificationBadge.displayName = 'OrganizationVerificationBadge'

export default OrganizationVerificationBadge
