...
const ProjectManagePageInfos: React.FC<
  ProjectManagePageInfosProps & InjectedIntlProps
> = ({ className, intl, project }) => (
    ...
    <div className="col-md-6 col-lg-3 mb-md-3 mb-lg-0">
      <Info className="ratio">
        ...
        <div style={{ backgroundColor: colors[0] }} className="ratio-body">
          <VolunteerIcon width={24} height={24} fill="#fff" className="mb-2" />
          <InfoValue>
...
export default React.memo(withIntl(ProjectManagePageInfos))
